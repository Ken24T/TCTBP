...
Purpose:
Reserved for repositories that define a deploy target. This template repo does not currently deploy a runtime artefact.
...
- a future version of this repository defines a deploy target
